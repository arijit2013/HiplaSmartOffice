...
-(void)viewWillAppear:(BOOL)animated{
    ...
    //self.lbl_DepartmentName.text = [NSString stringWithFormat:@"%@",_nameStr];
    
    NSString *isMeetingTimeSlot  = [Userdefaults objectForKey:@"isMeetingTimeSlot"];
    
    if ([isMeetingTimeSlot isEqualToString:@"60 min"]) {
        
        hours = @[@"12:00 AM-01:00 AM",@"01:00 AM-02:00 AM",@"02:00 AM-03:00 AM",@"03:00 AM-04:00 AM",@"04:00 AM-05:00 AM",@"05:00 AM-06:00 AM",@"06:00 AM-07:00 AM",@"07:00 AM-08:00 AM",@"08:00 AM-09:00 AM",@"09:00 AM-10:00 AM",@"10:00 AM-11:00 PM",@"11:00 AM-12:00 PM",@"12:00 PM-01:00 PM",@"01:00 PM-02:00 PM",@"02:00 PM-03:00 PM",@"03:00 PM-04:00 PM",@"04:00 PM-05:00 PM",@"05:00 PM-06:00 PM",@"06:00 PM-07:00 PM",@"07:00 PM-08:00 PM",@"08:00 PM-09:00 PM",@"09:00 PM-10:00 PM",@"10:00 PM-11:00 PM",@"11:00 PM-12:00 AM"];
        
    } else {
        
        hours = @[@"12:00 AM-12:30 AM",@"12:30 AM-01:00 AM",@"01:00 AM-01:30 AM",@"01:30 AM-02:00 AM",@"02:00 AM-02:30 AM",@"02:30 AM-03:00 AM",@"03:00 AM-03:30 AM",@"03:30 AM-04:00 AM",@"04:00 AM-04:30 AM",@"04:30 AM-05:00 AM",@"05:00 AM-05:30 AM",@"05:30 AM-06:00 AM",@"06:00 AM-06:30 AM",@"06:30 AM-07:00 AM",@"07:00 AM-07:30 AM",@"07:30 AM-08:00 AM",@"08:00 AM-08:30 AM",@"08:30 AM-09:00 AM",@"09:00 AM-09:30 AM",@"09:30 AM-10:00 AM",@"10:00 AM-10:30 AM",@"10:30 AM-11:00 PM",@"11:00 AM-11:30 AM",@"11:30 AM-12:00 PM",@"12:00 PM-12:30 PM",@"12:30 PM-01:00 PM",@"01:00 PM-01:30 PM",@"01:30 PM-02:00 PM",@"02:00 PM-02:30 PM",@"02:30 PM-03:00 PM",@"03:00 PM-03:30 PM",@"03:30 PM-04:00 PM",@"04:00 PM-04:30 PM",@"04:30 PM-05:00 PM",@"05:00 PM-05:30 PM",@"05:30 PM-06:00 PM",@"06:00 PM-06:30 PM",@"06:30 PM-07:00 PM",@"07:00 PM-07:30 PM",@"07:30 PM-08:00 PM",@"08:00 PM-08:30 PM",@"08:30 PM-09:00 PM",@"09:00 PM-09:30 PM",@"09:30 PM-10:00 PM",@"10:00 PM-10:30 PM",@"10:30 PM-11:00 PM",@"11:00 PM-11:30 PM",@"11:30 PM-12:00 AM"];
    ...
    isChekingInternet = NO;
    
    [self checkNet];
    
    if ([self.lbl_DepartmentName.text length]==0)
    {
        self.lbl_DepartmentName.text = [Userdefaults objectForKey:@"Name"];
    }
...
-(void)checkNet{
    ...
    if (!isChekingInternet) {
        
        if ([[Reachability reachabilityForInternetConnection]currentReachabilityStatus]==NotReachable)
        {
            
            self->isChekingInternet = YES;
            
            UIAlertController * alert = [UIAlertController
                                         alertControllerWithTitle:nil
                                         message:@"No internet connection found, please check again."
...
-(void)selectAutoDates
{
    if ([arrTimes count]>1) {
        ...
        int minInt = [[copyArr valueForKeyPath:@"@min.doubleValue"] intValue];
        int maxInt = [[copyArr valueForKeyPath:@"@max.doubleValue"] intValue];
        
        //        int minInt = (int)[[copyArr lastObject] integerValue];
        //        int maxInt = (int)[copyArr[0] integerValue];
...
{
    //Show an error?
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Please allow _phonebook access."
                                                        message:nil
                                                       delegate:nil
...
-(void)getUseravailTimeforDate:(NSString *)Date
{
    ...
    if ([_nameStr length]==0) {
        ...
        [self.lbl_DepartmentName setText:_nameStr];
    }
...
-(void)getEmployeeavailTimeforDate:(NSString *)Date
{
    ...
    NSDictionary *params = @{@"phone":_phone,@"date":Date};
...
//                                            [self.navigationController pushViewController:profileVC animated:YES];
            ...
            if ([fromTime length]>0) {
                ...
                if ([type isEqualToString:@"Guest"]) {
                    ...
                    if(([_phone isEqualToString:@""])||([_phone length]==0)){
                        
                        params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fDateSel,@"sdate":sDateSel,@"pushid_g":@"",@"phone":@"",@"location":@""};
                        
                    }else{
                        
                        params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":@"",@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fDateSel,@"sdate":sDateSel,@"pushid_g":@"",@"phone":_phone,@"location":@""};
                ...
                else
                {
                    if(([_phone isEqualToString:@""])||([_phone length]==0)){
                        ...
                        params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fDateSel,@"sdate":sDateSel,@"pushid_g":@"",@"phone":_phone,@"location":self->roomId};
                ...
                [manager POST:host_url parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
                    ...
                    if ([success isEqualToString:@"success"]) {
                        ...
                        else if ([[responseDict allKeys] containsObject:@"user_message"])
                        {
                            NSString *msg = [responseDict objectForKey:@"user_message"];
                    ...
                    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Unfortunetly your meeting cannot be scheduled. Please try again."
                                                                        message:nil
                                                                       delegate:nil
                                                              cancelButtonTitle:@"Ok"
                                                              otherButtonTitles:nil];
                ...
                if (compare==NSOrderedAscending) {
                    ...
                    if ([type isEqualToString:@"Guest"]) {
                        ...
                        if(([_phone isEqualToString:@""])||([_phone length]==0)){
                            ...
                            params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":@"",@"location":@""};
                            
                        }else{
                            
                            params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":@"",@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":_phone,@"location":@""};
                    ...
                    else
                    {
                        if(([_phone isEqualToString:@""])||([_phone length]==0)){
                            ...
                            params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtfld_Agenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":_phone,@"location":self->roomId};
...
-(void)AddMeetingViewController:(AddMeetingViewController *)adm getName:(NSString *)name andphNo:(CNContact *)contact
{
    ...
    if ([_nameStr length]>0)
    {
        [Userdefaults setObject:_nameStr forKey:@"Name"];
    ...
    _phone = [[[contact.phoneNumbers firstObject] value] stringValue];
    ...
    _phoneStr = [_phoneStr stringByReplacingOccurrencesOfString:@"+91" withString:@""];
    
    NSCharacterSet *digits = [NSCharacterSet decimalDigitCharacterSet];
    NSCharacterSet *illegalCharacters = [digits invertedSet];
    NSArray *components = [_phoneStr componentsSeparatedByCharactersInSet:illegalCharacters];
